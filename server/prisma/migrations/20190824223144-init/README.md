# Migration `20190824223144-init`

This migration has been generated by Vimalraj Selvam at 8/24/2019, 10:31:44 PM.
...
You can use a specific Photon built for this migration (20190824223144-init)
in your `before` or `after` migration script like this:

```ts
import Photon from '@generated/photon/20190824223144-init'
